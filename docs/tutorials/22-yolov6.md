...
训练时，你拥有奢侈的时间——可以堆叠复杂的结构，让模型学得更透彻。

推理时，你锱铢必较——每一毫秒都是成本，每一次乘法都要精打细算。

**能不能两全其美？**

YOLO v6 给出了答案：**结构重参数化**。

训练时，它像一棵枝繁叶茂的大树，三个分支共同汲取养分——3×3 卷积、1×1 卷积、恒等映射，各司其职，相得益彰。

推理时，这棵树悄然蜕变，所有枝干融为一体，化作一根坚实的树干——单个 3×3 卷积，轻装上阵，快如闪电。
