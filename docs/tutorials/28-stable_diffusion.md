...
你一定见过云。那些飘忽不定的白色团块，在风的雕琢下，渐渐显出形状——这朵像马，那朵像帆船。

你的朋友说："我看不出来啊。"
你说："再盯久一点，让眼睛学会联想。"

Stable Diffusion 也是如此。

它从一片**纯噪声**开始——就像电视没有信号时的雪花点，毫无意义，一片混沌。然后，神奇的事情发生了：

在文本的指引下，它开始"去噪"。一步一步，模糊的轮廓渐渐清晰，杂乱的色斑慢慢归位。先是隐约的形状，再是可辨的物体，最后——
...
**Stable Diffusion —— 从噪声中呼唤艺术**，一句文字，一幅画。
