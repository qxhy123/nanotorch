...
答案：不需要成为数学家，但需要理解数学语言。

神经网络本质上是一连串的数学运算：矩阵乘法、导数、概率分布、最优化。如果你不懂它们，深度学习就是黑盒；如果你懂它们，一切都是透明的、可理解的、可掌控的。
...
本教程将带你一步步掌握这些基础。每一个概念，都会结合深度学习的实际应用来讲解——不只是"是什么"，更是"为什么需要"。
