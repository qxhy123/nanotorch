...
那么 YOLO v4 就是它的赛道升级版——同样的底盘，却换了更强的心脏，更聪明的变速箱，更轻量化的车身。

2020年，YOLO v4 带着两个"锦囊"横空出世：

**Bag of Freebies（免费礼包）**：只在训练时生效的技巧——数据增强、难例挖掘、标签平滑...它们让模型学得更好，推理时却不会拖慢一丝一毫。

**Bag of Specials（特别锦囊）**：稍增推理成本，却带来显著提升——注意力模块、增强的感受野、更精细的特征融合...
