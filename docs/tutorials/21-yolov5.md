...
YOLO v5 带来的不是一场革命，而是一次贴心的问候。

它来自 Ultralytics，一个年轻而务实的团队。他们没有追逐炫目的创新，而是问了一个朴素的问题：

**"能不能让 YOLO 更好用？"**

于是，他们打造了一个完整的产品线——

**Nano（n）**：轻盈如燕，能在手机上奔跑，为边缘设备而生。

**Small（s）**：麻雀虽小，五脏俱全，是性价比之选。
