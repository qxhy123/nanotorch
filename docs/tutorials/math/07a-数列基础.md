...
这就形成一个**数列**：$1, 2, 3, 4, 5, \ldots$

**数列就是一串按顺序排列的数字！**

生活中的数列例子：
- **楼梯台阶**：1阶、2阶、3阶...（等差数列）
- **细胞分裂**：1个、2个、4个、8个...（等比数列）
- **存款利息**：本金×利率的n次方
...
| 表示方法 | 示例 | 通俗解释 |
|----------|------|----------|
| 列举法 | $1, 3, 5, 7, 9, \ldots$ | 直接写出来 |
| 通项公式 | $a_n = 2n - 1$ | 一个公式算第n项 |
| 递推公式 | $a_1 = 1, a_{n+1} = a_n + 2$ | 用前一项算后一项 |

**手把手计算通项**：对于数列 $1, 3, 5, 7, 9, \ldots$
