...
**指数函数** $e^x$ 就像这个细菌繁殖：
- 当 $x$ 增加1，函数值变成原来的 $e$ 倍（约2.718倍）
- $e^0 = 1$（开始只有1个）
- $e^1 = e \approx 2.718$
- $e^2 \approx 7.389$
- $e^{10} \approx 22026$（增长非常快！）
...
第2项：1/1!     = 1       累计：2
第3项：1/2!     = 0.5     累计：2.5
第4项：1/3!     = 0.1667  累计：2.6667
第5项：1/4!     = 0.0417  累计：2.7084
第6项：1/5!     = 0.0083  累计：2.7167
...
真实值：e ≈ 2.71828
```

**收敛很快！**只需几项就能得到相当精确的结果。
