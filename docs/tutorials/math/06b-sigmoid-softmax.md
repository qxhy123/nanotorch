...
想象老师在批改试卷：
- 原始分数：可能是 -100 到 +100 之间的任何数
- 我们需要把它转换成 **0% 到 100%** 的概率

**Sigmoid 函数就像一个"概率转换器"**：
