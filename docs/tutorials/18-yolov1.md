...
在那之前，计算机看世界的方式像极了盲人摸象——

它小心翼翼地举起两千个放大镜，逐个审视图片的每个角落："这里有东西吗？这个呢？这个呢？"找到可疑区域后，再送去辨认。繁琐、缓慢、笨拙。

直到有人问了这样一个问题：

**"为什么不能像人类一样，一眼看全？"**

于是 YOLO 诞生了。它不再举着放大镜到处摸索，而是将图片轻轻划分为 7×7 的网格——就像在画面上落下一道窗棂。每个格子只需回答一个问题："我这里有东西吗？是什么？在哪里？"
...
**这便是 YOLO —— You Only Look Once**，一眼万年，刹那芳华。
