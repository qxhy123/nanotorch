"""
YOLO v9 Loss Function

PGI (Programmable Gradient Information) based loss.
"""
...
def encode_targets_v9(boxes, labels, grid_sizes=[80, 40, 20], num_classes=80, image_size=640):
    targets = {}
...
def decode_predictions_v9(predictions, conf_threshold=0.25, num_classes=80, image_size=640):
