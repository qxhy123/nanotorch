"""
YOLO v10 Loss Function

NMS-free training loss.
"""
...
class YOLOv10LossSimple(Module):
    def __init__(self, num_classes: int = 80):
        super().__init__()
        self.num_classes = num_classes
...
def encode_targets_v10(boxes, labels, grid_sizes=[80, 40, 20], num_classes=80, image_size=640):
    targets = {}
...
def decode_predictions_v10(predictions, conf_threshold=0.25, num_classes=80, image_size=640):
