"""
YOLO v5 Loss Function

Similar to previous YOLO versions with:
1. CIoU loss for bounding box regression
                    ...
                    for a in range(num_anchors):
                        ...
                        for t_idx, box in enumerate(boxes):
                            ...
                            iou = self._compute_iou(
                                cell_x, cell_y, anchor_w / 640, anchor_h / 640,
                                gt_cx / 640, gt_cy / 640, gt_w / 640, gt_h / 640
                            )
...
class YOLOv5LossSimple(Module):
    """Simplified YOLO v5 Loss for testing."""
...
def encode_targets_v5(
    ...
    """Encode ground truth to YOLO v5 format."""
    targets = {}
...
def decode_predictions_v5(
    ...
    """Decode YOLO v5 predictions to bounding boxes."""
    num_anchors = 3
